package com.mvhub.mvhubplus.utils.helpers.shimmer;
    ...
    private int getColor() {
        if (KsPreferenceKeys.getInstance().getCurrentTheme().equalsIgnoreCase(AppConstants.LIGHT_THEME)) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                return getContext().getColor(R.color.shimmerLight);
            } else {
                return getResources().getColor(R.color.shimmerLight);
            }
        } else {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                return getContext().getColor(R.color.shimmer_color);
            } else {
                return getResources().getColor(R.color.shimmer_color);
            }
        }
    }
