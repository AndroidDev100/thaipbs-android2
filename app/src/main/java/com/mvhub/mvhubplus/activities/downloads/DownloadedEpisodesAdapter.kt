...
class DownloadedEpisodesAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>, MediaDownloadable.DownloadEventListener, com.mvhub.mvhubplus.utils.helpers.downloads.VideoListListener {
    ...
    private var viewHolder: com.mvhub.mvhubplus.activities.downloads.DownloadedEpisodesAdapter.LandscapeItemRowHolder? = null
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return viewHolder as com.mvhub.mvhubplus.activities.downloads.DownloadedEpisodesAdapter.LandscapeItemRowHolder
    }
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        setLandscapeData(viewHolder as com.mvhub.mvhubplus.activities.downloads.DownloadedEpisodesAdapter.LandscapeItemRowHolder, position)
    }

    private fun setLandscapeData(viewHolder: com.mvhub.mvhubplus.activities.downloads.DownloadedEpisodesAdapter.LandscapeItemRowHolder, position: Int) {
...
//        }
        ...
        downloadHelper.getCatalog().getVideoDownloadStatus(p0.videoId,
                object : OfflineCallback<DownloadStatus> {
                    override fun onSuccess(p0: DownloadStatus?) {
                        com.mvhub.mvhubplus.utils.cropImage.helpers.Logger.e("DownloadStatus", p0?.code.toString());
                        when (p0?.code) {
    ...
    private fun updateDownloadStatus(viewHolder: com.mvhub.mvhubplus.activities.downloads.DownloadedEpisodesAdapter.LandscapeItemRowHolder, currentVideoItem: DownloadedEpisodes, position: Int) {
