package com.mvhub.mvhubplus.activities.watchList.ui;
...
import com.mvhub.enums.ImageType;
import com.mvhub.mvhubplus.Bookmarking.BookmarkingViewModel;
import com.mvhub.mvhubplus.activities.watchList.adapter.WatchHistoryAdapter;
import com.mvhub.mvhubplus.activities.watchList.adapter.WatchListAdapter;
import com.mvhub.mvhubplus.activities.watchList.viewModel.WatchListViewModel;
...
import com.mvhub.mvhubplus.beanModel.ContinueRailModel.CommonContinueRail;
...
import com.mvhub.mvhubplus.databinding.WatchListActivityBinding;
...
public class WatchListActivity extends BaseBindingActivity<WatchListActivityBinding> implements WatchListAdapter.WatchListAdaperListener, WatchHistoryAdapter.WatchHistoryAdaperListener, WatchListAdapter.DeleteWatchList, AlertDialogFragment.AlertDialogListener, ItemClickListener, View.OnClickListener {
    ...
    private com.mvhub.mvhubplus.beanModel.allWatchList.ItemsItem itemValue;
                ...
                bookmarkingViewModel.getMywatchListData(token, counter, AppConstants.PAGE_SIZE).observe(this, responseWatchHistoryAssetList -> {
                    if (responseWatchHistoryAssetList.isStatus()) {
                        if (responseWatchHistoryAssetList.getData() != null) {
                            ...
                            String videoIds = "";
                            if (responseWatchHistoryAssetList.getData() != null) {
                                List<com.mvhub.watchHistory.beans.ItemsItem> watchHistoryList = responseWatchHistoryAssetList.getData().getItems();
                                for (com.mvhub.watchHistory.beans.ItemsItem historyItem : watchHistoryList) {
    ...
    @Override
    public void onWatchListItemClicked(com.mvhub.mvhubplus.beanModel.allWatchList.ItemsItem itemValue) {
    ...
    @Override
    public void onDeleteClick(com.mvhub.mvhubplus.beanModel.allWatchList.ItemsItem itemValue) {
        try {
            deleteItem = true;
            isloggedout = false;
