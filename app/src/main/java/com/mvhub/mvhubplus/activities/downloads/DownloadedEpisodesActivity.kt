...
import com.mvhub.mvhubplus.databinding.ActivityDownloadedEpisodesBinding
import kotlinx.android.synthetic.main.activity_my_downloads.*
import java.io.Serializable

class DownloadedEpisodesActivity() : com.mvhub.mvhubplus.baseModels.BaseBindingActivity<ActivityDownloadedEpisodesBinding>(), MediaDownloadable.DownloadEventListener, com.mvhub.mvhubplus.utils.helpers.downloads.VideoListListener {
    ...
    private lateinit var downloadsAdapter: com.mvhub.mvhubplus.activities.downloads.DownloadedEpisodesAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        downloadHelper.getAllEpisodesOfSeries(seriesId, seasonNumber).observe(this, Observer {
            downloadsAdapter = com.mvhub.mvhubplus.activities.downloads.DownloadedEpisodesAdapter(this@DownloadedEpisodesActivity, it)
