...
import com.mvhub.mvhubplus.databinding.ListDownloadItemBinding
import com.mvhub.mvhubplus.utils.helpers.downloads.DownloadedVideoActivity
...
class DownloadsAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>, MediaDownloadable.DownloadEventListener, com.mvhub.mvhubplus.utils.helpers.downloads.VideoListListener {
    ...
    private var viewHolder: com.mvhub.mvhubplus.activities.downloads.DownloadsAdapter.LandscapeItemRowHolder? = null
    ...
    constructor(activity: Activity, downloadsList: DownloadModel) {
        ...
        downloadsList.downloadVideos.forEachIndexed { index, downloadedVideo ->
            val b = downloadedVideo.downloadType == com.mvhub.mvhubplus.utils.MediaTypeConstants.getInstance().series || downloadedVideo.downloadType ==  com.mvhub.mvhubplus.utils.MediaTypeConstants.getInstance().episode
            if (b) {
...
*/
                ...
                downloadHelper.findOfflineVideoById(downloadedVideo.videoId, object : OfflineCallback<Video> {
                    override fun onSuccess(video: Video) {
                        com.mvhub.mvhubplus.utils.cropImage.helpers.Logger.e("Video Found", "true")
                        if (!video.isClearContent) {
                            if (video.licenseExpiryDate!!.time >= System.currentTimeMillis()) {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return viewHolder as com.mvhub.mvhubplus.activities.downloads.DownloadsAdapter.LandscapeItemRowHolder
    }
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        setLandscapeData(viewHolder as com.mvhub.mvhubplus.activities.downloads.DownloadsAdapter.LandscapeItemRowHolder, position)
    }

    private fun setLandscapeData(viewHolder: com.mvhub.mvhubplus.activities.downloads.DownloadsAdapter.LandscapeItemRowHolder, position: Int) {
        val currentVideoItem = downloadedVideos[position]
        if (currentVideoItem.downloadType == com.mvhub.mvhubplus.utils.MediaTypeConstants.getInstance().series) {
            try {
        ...
        viewHolder.itemBinding.root.setOnClickListener {
            if (currentVideoItem.downloadType != com.mvhub.mvhubplus.utils.MediaTypeConstants.getInstance().series) {
                ...
                downloadHelper.findOfflineVideoById(currentVideoItem.videoId, object : OfflineCallback<Video> {
                    override fun onSuccess(p0: Video?) {
                        if (status.code== DownloadStatus.STATUS_COMPLETE){
                            com.mvhub.mvhubplus.utils.cropImage.helpers.Logger.e("isParcelable", (p0 is Parcelable).toString())
                ...
                val downloadedEpisodesIntent = Intent(context, com.mvhub.mvhubplus.activities.downloads.DownloadedEpisodesActivity::class.java)
    ...
    private fun updateDownloadStatus(viewHolder: com.mvhub.mvhubplus.activities.downloads.DownloadsAdapter.LandscapeItemRowHolder, currentVideoItem: DownloadedVideo, position: Int) {
                        ...
                        if (currentVideoItem.downloadType == com.mvhub.mvhubplus.utils.MediaTypeConstants.getInstance().series) {
                            ...
                            when (p0?.code) {
                                DownloadStatus.STATUS_COMPLETE -> {
                                    viewHolder.itemBinding.downloadStatus = com.mvhub.mvhubplus.enums.DownloadStatus.DOWNLOADED
                                    viewHolder.itemBinding.descriptionTxt.text = getFileSize(p0.actualSize)
                                }
                                DownloadStatus.STATUS_DOWNLOADING -> {
                                    viewHolder.itemBinding.downloadStatus = com.mvhub.mvhubplus.enums.DownloadStatus.DOWNLOADING
                                ...
                                DownloadStatus.STATUS_PAUSED -> {
                                    viewHolder.itemBinding.downloadStatus = com.mvhub.mvhubplus.enums.DownloadStatus.PAUSE
    ...
    override fun onDownloadPaused(p0: Video, p1: DownloadStatus) {
        com.mvhub.mvhubplus.utils.cropImage.helpers.Logger.e(TAG, "onDownloadPaused" + p0.id)
    ...
    override fun onDownloadCanceled(p0: Video) {
        com.mvhub.mvhubplus.utils.cropImage.helpers.Logger.e("DownloadCancelled", "True")
    }
    ...
    override fun onDownloadProgress(p0: Video, p1: DownloadStatus) {
        com.mvhub.mvhubplus.utils.cropImage.helpers.Logger.e(TAG, "onDownloadProgress" + p1.progress)
        notifyVideoChanged(p0.id, p1)
    }
    ...
    override fun resumeVideoDownload(video: Video) {
        com.mvhub.mvhubplus.utils.cropImage.helpers.Logger.e(TAG, "resumeVideoDownload")
    }
    ...
    override fun downloadStatus(videoId: String, downloadStatus: DownloadStatus?) {
        com.mvhub.mvhubplus.utils.cropImage.helpers.Logger.e(TAG, "downloadStatus" + downloadStatus?.progress)
    }
