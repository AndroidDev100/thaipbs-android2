...
import com.mvhub.baseClient.BaseClient;
import com.mvhub.baseClient.BaseConfiguration;
import com.mvhub.baseClient.BaseDeviceType;
import com.mvhub.baseClient.BaseGateway;
import com.mvhub.baseClient.BasePlatform;
...
import com.mvhub.mvhubplus.activities.splash.dialog.ConfigFailDialog;
...
import com.mvhub.mvhubplus.BuildConfig;
...
import com.mvhub.mvhubplus.databinding.ActivitySplashBinding;
...
import com.mvhub.mvhubplus.utils.config.ConfigManager;
...
import com.mvhub.mvhubplus.utils.helpers.ForceUpdateHandler;
...
//setFullScreen();
        ...
        if (TextUtils.isEmpty(KsPreferenceKeys.getInstance().getQualityName())) {
            KsPreferenceKeys.getInstance().setQualityName(getApplicationContext().getResources().getString(com.mvhub.brightcovelibrary.R.string.auto));
