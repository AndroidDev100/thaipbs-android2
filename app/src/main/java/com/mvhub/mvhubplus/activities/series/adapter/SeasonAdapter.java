package com.mvhub.mvhubplus.activities.series.adapter;
...
import com.mvhub.mvhubplus.databinding.RowEpisodeListBinding;
import com.mvhub.mvhubplus.utils.SortSeasonAdapterItems;
            ...
            public void onSuccess(DownloadStatus downloadStatus) {
                ...
                switch (downloadStatus.getCode()) {
                    case DownloadStatus.STATUS_NOT_QUEUED: {
                        holder.itemBinding.setDownloadStatus(com.mvhub.mvhubplus.enums.DownloadStatus.START);
                    }
                    break;
                    case DownloadStatus.STATUS_PENDING:
                    case DownloadStatus.STATUS_QUEUEING: {
                        holder.itemBinding.setDownloadStatus(com.mvhub.mvhubplus.enums.DownloadStatus.DOWNLOADING);
                    }
                    break;
                    case DownloadStatus.STATUS_COMPLETE: {
                        holder.itemBinding.setDownloadStatus(com.mvhub.mvhubplus.enums.DownloadStatus.DOWNLOADED);
                    }
                    break;
                    ...
                    case DownloadStatus.STATUS_PAUSED: {
                        holder.itemBinding.setDownloadStatus(com.mvhub.mvhubplus.enums.DownloadStatus.PAUSE);
                    }
                    break;
