package com.mvhub.mvhubplus.networking.intercepter;
...
public class ErrorCodesIntercepter {
    ...
    public SignupResponseAccessToken manualSignUp(Response<com.mvhub.userManagement.bean.LoginResponse.LoginResponseModel> response) {
    ...
    public LoginResponseModel fbLogin(Response<com.mvhub.userManagement.bean.LoginResponse.LoginResponseModel> response) {
    ...
    public LoginResponseModel Login(Response<com.mvhub.userManagement.bean.LoginResponse.LoginResponseModel> response) {
    ...
    public UserProfileResponse userProfile(Response<com.mvhub.userManagement.bean.UserProfile.UserProfileResponse> response) {
