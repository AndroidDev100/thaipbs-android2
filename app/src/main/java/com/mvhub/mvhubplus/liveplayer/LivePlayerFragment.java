package com.mvhub.mvhubplus.liveplayer;
...
import com.mvhub.brightcovelibrary.NetworkChangeReceiver;
...
import com.mvhub.mvhubplus.callbacks.commonCallbacks.PhoneListenerCallBack;
import com.mvhub.mvhubplus.utils.cropImage.helpers.Logger;
import com.mvhub.mvhubplus.utils.helpers.PhoneStateHelper;
...
public class LivePlayerFragment extends Fragment implements Player.EventListener, NetworkChangeReceiver.ConnectivityReceiverListener, PhoneListenerCallBack {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bottomMargin = (int) getResources().getDimension(com.mvhub.brightcovelibrary.R.dimen.caption_margin);
        return result;
    }
    ...
    private void resetFullScreenMargin() {
        mFullScreenIcon.setBackgroundResource(com.mvhub.brightcovelibrary.R.drawable.full_screen);
    ...
    private void fullScreenMargin() {
        mFullScreenIcon.setBackgroundResource(com.mvhub.brightcovelibrary.R.drawable.exit_full_screen);
        FrameLayout.LayoutParams captionParams = (FrameLayout.LayoutParams) fullScreenLayout.getLayoutParams();
    ...
    public void onPause() {
        ...
        if (player != null) {
            pauseButton.setVisibility(View.VISIBLE);
            pauseButton.setBackgroundResource(com.mvhub.brightcovelibrary.R.drawable.play);
            player.setPlayWhenReady(false);
        }
    }
    ...
    public void ShowAndHideView() {
        try {
            ...
            Animation animationFadeOut = AnimationUtils.loadAnimation(getActivity(), com.mvhub.brightcovelibrary.R.anim.fade_out);
            Animation animationFadeIn = AnimationUtils.loadAnimation(getActivity(), com.mvhub.brightcovelibrary.R.anim.fade_in);
