package com.mvhub.mvhubplus.repository.userManagement;
...
import com.mvhub.userManagement.callBacks.ForgotPasswordCallBack;
import com.mvhub.userManagement.callBacks.LoginCallBack;
import com.mvhub.userManagement.callBacks.UserProfileCallBack;
import com.google.gson.Gson;
import com.google.gson.JsonNull;
import com.google.gson.JsonObject;
import com.mvhub.mvhubplus.beanModel.connectFb.ResponseConnectFb;
import com.mvhub.mvhubplus.beanModel.forgotPassword.CommonResponse;
...
import com.mvhub.mvhubplus.beanModel.responseModels.SignUp.SignupResponseAccessToken;
...
public class RegistrationLoginRepository {
    ...
    public LiveData<LoginResponseModel> getLoginAPIResponse(Context context, String username, String pwd) {
        ...
        BaseCategoryServices.Companion.getInstance().loginService(username, pwd, new LoginCallBack() {
            @Override
            public void success(boolean status, Response<com.mvhub.userManagement.bean.LoginResponse.LoginResponseModel> response) {
                if (status) {
    ...
    public LiveData<UserProfileResponse> getUserProfile(Context context, String token) {
        ...
        BaseCategoryServices.Companion.getInstance().userProfileService(token, new UserProfileCallBack() {
            @Override
            public void success(boolean status, Response<com.mvhub.userManagement.bean.UserProfile.UserProfileResponse> response) {
