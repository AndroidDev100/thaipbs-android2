package com.mvhub.mvhubplus.beanModelV2.uiConnectorModelV2;
...
import com.mvhub.mvhubplus.beanModelV2.continueWatching.DataItem;
import com.mvhub.mvhubplus.beanModelV2.searchV2.ItemsItem;
import com.mvhub.mvhubplus.beanModelV2.videoDetailsV2.EnveuVideoDetailsBean;
import com.mvhub.mvhubplus.utils.CustomeFields;
...
public class EnveuVideoItemBean implements Serializable {
    ...
    public EnveuVideoItemBean(EnveuVideoDetailsBean details) {
        try {
            ...
            this.duration = (long) details.getData().getDuration();
