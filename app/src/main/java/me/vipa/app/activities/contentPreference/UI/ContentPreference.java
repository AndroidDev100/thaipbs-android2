...
public class ContentPreference extends BaseBindingActivity<ActivityContentPreferenceBinding> {
    ...
    private void setAdapter() {
        adatperContentPreference = new ContentPreferenceAdapter(ContentPreference.this, AppCommonMethod.getConfigResponse().getData().getAppConfig().getContentPreference());
